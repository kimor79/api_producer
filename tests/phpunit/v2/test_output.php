...
class APIProducerV2OutputTest extends PHPUnit_Framework_TestCase {

	protected $api;

	protected function setUP() {
		$this->api = new TestAPIProducerV2Output();
	}

	public function testFormatData_json() {
		$got = $this->api->formatData_json(array('a' => 1));

		$this->assertSame('{"a":1}', $got);
	}

	public function testFormatData_print_r() {
		$got = $this->api->formatData_print_r(array('a' => 1));
		$expected = "<pre>Array\n(\n    [a] => 1\n)\n</pre>";
	...
	public function testGetParameter() {
		$got = $this->api->getParameter('');
		$this->assertNull($got);
	}

	public function testGetParameter1() {
		$got = $this->api->getParameter('NOEXIST');
		$this->assertNull($got);
	}

	public function testGetParameter2() {
		$got = $this->api->getParameter('outputFormat');
		$this->assertSame('json', $got);
	}
